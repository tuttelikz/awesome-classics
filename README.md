...
- Писатели:
    - Алексадр Дюма (отец)
        ...
        - [Анж Питу](https://github.com/tuttelikz/awesome-classics/blob/master/writers/dumas/AnjPitu.md) :fire:
...
- Экранизации по книгам:
    ...
    - ["Отверженные", 1982](https://github.com/tuttelikz/awesome-classics/blob/master/films/Otverjennye.md) [[ссылка на фильм]](https://www.youtube.com/watch?v=ysX2waveBVY)
